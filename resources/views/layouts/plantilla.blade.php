...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="no-skin">
                ...
                >
                    <ul class="nav ace-nav">
                        <li class="transparent dropdown-modal">
                            ...
                            >
                                <i
                                    class="ace-icon fa fa-bell icon-animated-bell"
                                ></i>
                            </a>
                            ...
                            >
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        >
                                            <ul
                                                class="dropdown-menu-right dropdown-navbar dropdown-menu"
                                            >
                                                ...
                                                <li class="dropdown-footer">
                                                    <a href="#">
                                                        ...
                                                        <i
                                                            class="ace-icon fa fa-arrow-right"
                                                        ></i>
                                                    </a>
                                                </li>
                                            </ul>
        ...
        <div class="main-container ace-save-state" id="main-container">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="top-menu.html">
                                            <i
                                                class="menu-icon fa fa-caret-right"
                                            ></i>
                                            Top Menu
                                        </a>
                            ...
                            <li class="">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="#">
                                            <i
                                                class="menu-icon fa fa-leaf green"
                                            ></i>
                                            Item #1
                                        </a>
                                    ...
                                    <li class="">
                                        <a href="#" class="dropdown-toggle">
                                            <i
                                                class="menu-icon fa fa-pencil orange"
                                            ></i>
                                        ...
                                        <ul class="submenu">
                                            <li class="">
                                                <a href="#">
                                                    <i
                                                        class="menu-icon fa fa-plus purple"
                                                    ></i>
                                                    Add Product
                                                </a>
                                            ...
                                            <li class="">
                                                <a href="#">
                                                    <i
                                                        class="menu-icon fa fa-eye pink"
                                                    ></i>
                                                    View Products
                                                </a>
                    ...
                    <li class="">
                        <a href="calendar.html">
                            ...
                            <span class="menu-text">
                                ...
                                >
                                    <i
                                        class="ace-icon fa fa-exclamation-triangle red bigger-130"
                                    ></i>
                                </span>
                            </span>
                        </a>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="invisible">
                                    ...
                                    >
                                        ...
                                        <i
                                            class="ace-icon fa fa-dashboard white bigger-125"
                                        ></i>
                                    </button>
                                    ...
                                    >
                                        <ul class="nav nav-list">
                                            <li class="hover">
                                                <a href="#">
                                                    <i
                                                        class="menu-icon fa fa-tachometer"
                                                    ></i>
                                                    <span class="menu-text">
                                                        Dashboard
                                                    </span>
                                            ...
                                            <li class="hover">
                                                <a href="#">
                                                    <i
                                                        class="menu-icon fa fa-list-alt"
                                                    ></i>
                                                    <span class="menu-text"
                                                        >Widgets</span
                                                    >
                                            ...
                                            <li class="hover">
                                                <a href="#">
                                                    <i
                                                        class="menu-icon fa fa-picture-o"
                                                    ></i>
                                                    <span class="menu-text">
                                                        Gallery
                                                    </span>
                                ...
                                <div class="hidden-sm hidden-xs">
                                    <button
                                        type="button"
                                        class="sidebar-collapse btn btn-white btn-primary"
                                        data-target="#sidebar2"
                                    >
                                        <i
                                            id="sidebar2-toggle-icon"
                                            class="ace-icon fa fa-angle-double-up ace-save-state"
                                            data-icon1="ace-icon fa fa-angle-double-up"
                                            data-icon2="ace-icon fa fa-angle-double-down"
                                        ></i>
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="well well-sm">
                                        You can place multiple toggle buttons
                                        for multiple menus anywhere inside
                                        navbar!
                                    </div>
                                </div>
                                <!-- PAGE CONTENT ENDS -->
            ...
            >
                <i
                    class="ace-icon fa fa-angle-double-up icon-only bigger-110"
                ></i>
            </a>
        </div>
        <!-- /.main-container -->
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                $(document)
                    .on("settings.ace.two_menu", function (
                        e,
                        event_name,
                        event_val
                    ) {
                    ...
                    .triggerHandler("settings.ace.two_menu", [
                        "sidebar_fixed",
        ...
        <noscript
            ><div>
                <img
                    src="//mc.yandex.ru/watch/25836836"
